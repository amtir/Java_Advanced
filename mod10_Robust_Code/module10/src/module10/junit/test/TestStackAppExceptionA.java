...
public class TestStackAppExceptionA {

	private static final Logger log4j = Logger.getLogger(TestStackAppExceptionA.class.getName());
	...
	public void test1_overflow() throws MyStackException {
		int i = 0;
		log4j.debug("Inside the test1_overflow() method.");
	...
	@Test
	public void test2_overflow() throws MyStackException {
		int i = 0;
		log4j.debug("Inside the test1_overflow() method.");
		log4j.debug("Pusching " + volume + " elements in a stack");
		try {
